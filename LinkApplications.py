...
class WindowApplication:
    ...
    def sales_forecast_update(self):
        """For button - Sales Forecast Update;
        From GroupBox - Forecasting"""
    ...
    def sales_visuals(self):
        """For button - Sales Results Visuals;
        From GroupBox - Forecasting"""
    ...
    def lto_analysis(self):
        """For button - LTO Analysis;
        From GroupBox - Controlling"""
        self.lto_database = QMainWindow()
        self.ui = LTOAnalysis.Ui_lto_database()
        self.ui.setupUi(self.lto_database)
        self.lto_database.show()

    def local_fc_analysis(self):
        """For button - Local FC Analysis;
        From GroupBox - Controlling"""
