...
class Ui_SalesResultsVis(object):
    ...
    #     assign_tables = {"YTD 1": self.ytd_b2b1_table,
    #                      "YTD 2": self.ytd_b2b2_table,
    #                      "YTD 3": self.ytd_le_table,
    #                      "MTD 1": self.mtd_b2b_table1,
    #                      "MTD 2": self.mtd_b2b_table2,
    #                      "MTD 3": self.mtd_le_table
    #                      }
    #
    ...
    #     assign_tables = {"YTD R1": self.ytd_top_table,
    #                      "YTD R2": self.ytd_top_bu1_table,
    #                      "YTD R3": self.ytd_top_bu2_table,
    #                      "YTD R4": self.ytd_top_bu3_table,
    #                      "YTD R5": self.ytd_top_bu4_table,
    #
    #                      "MTD R1": self.mtd_top_table,
    #                      "MTD R2": self.mtd_top_bu1_table,
    #                      "MTD R3": self.mtd_top_bu2_table,
    #                      "MTD R4": self.mtd_top_bu3_table,
    #                      "MTD R5": self.mtd_top_bu4_table}
    #
    #     self.model = QSqlTableModel(db=db)
    #     self.model.setTable("sales")
    #     self.model.setEditStrategy(QSqlTableModel.OnManualSubmit)
    ...
    #     assign_charts = {"YTD PIE 1": self.ytd_b2b1_chart1,
    #                      "YTD PIE 2": self.ytd_b2b1_chart2,
    #                      "YTD PIE 3": self.ytd_b2b2_chart1,
    #                      "YTD PIE 4": self.ytd_b2b2_chart2,
    #                      "YTD PIE 5": self.ytd_le_chart1,
    #                      "YTD PIE 6": self.ytd_le_chart2,
    #
    #                      "MTD PIE 1": self.mtd_b2b1_chart1,
    #                      "MTD PIE 2": self.mtd_b2b1_chart2,
    #                      "MTD PIE 3": self.mtd_b2b2_chart1,
    #                      "MTD PIE 4": self.mtd_b2b2_chart2,
    #                      "MTD PIE 5": self.mtd_le_chart1,
    #                      "MTD PIE 6": self.mtd_le_chart2
    #                      }
    ...
    #     assign_charts = {"YTD PIE 3": self.ytd_b2b2_chart1,
    #                      "YTD PIE 4": self.ytd_b2b2_chart2,
    #                      "MTD PIE 3": self.mtd_b2b2_chart1,
    #                      "MTD PIE 4": self.mtd_b2b2_chart2}
